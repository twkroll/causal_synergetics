...
This log is append-only in decision identity. Earlier decisions are compacted without deleting or renumbering any `DEC-*` identifier.

## Decisions

### DEC-001 — Project Governance 0.1
Status: FROZEN. Canonical governance file controls.
...
Status: SATISFIED / CLOSED. Prior-Art & Definitions Audit returned `PASS — CLAIM-RESTRICTED`.

### DEC-006 — CORE dependency on first literature audit
Status: SATISFIED / CLOSED. CORE waited for LIT freeze.
...
Status: FROZEN. Canonical result `research/core/synergetic_sufficiency_boundary_0_1.md`; result commit `0ebd50e5c8c072cf59ae86502a25b97e78c4722f`; PASS — CLAIM-RESTRICTED; rollback `RP-003`.

### DEC-012 — Neural Minimal Benchmark 0.1
Status: SATISFIED / CLOSED. PASS; implementation/test `649a187125c4ad410e0b16b77accbfacfb577371`.
...
Status: FROZEN. Rollback `RP-004`.

### DEC-015 — Neural Historical Reachability 0.1
Status: SATISFIED / CLOSED. PASS; implementation `e342ef5c5cefae30df45e23bc667f149e818238c`.
...
Status: FROZEN. Orthogonal hidden-basis gauge selected prospectively.
...
Status: FROZEN. `(U,v)->(QU,Qv)` with `Q(phi)=R(phi)⊕I3`.
...
Status: FROZEN / COMPLETE. `FAIL — SPECIFICATION CLASSIFICATION GAP`; candidate and symmetry-aware Gram-PCA both exact; high N0 unrepaired; `36 passed`.

### DEC-034 — Nuisance-Invariance Result Freeze 0.1
Status: FROZEN. Rollback `RP-012`.

### DEC-035 — Nuisance-Invariance FAIL Integration Gate 0.1
Status: SATISFIED / CLOSED. `STOP / PARK RESPONSE-COORDINATE DIRECTION`.

### DEC-036 — Response-coordinate direction parked
Status: FROZEN. No repair because symmetry-aware Gram-PCA matches candidate and incremental value is low.
...
Status: STABLE / SELECTED. Cross-domain transfer selected.
...
Status: FROZEN / COMPLETE. PASS; `E_pass=0`, `E_B0_min=0.3549858420076152`, `E_B1_min=0.06534774384333092`, mean/COI closure error `3.885780586188048e-14`; `5 passed`.

### DEC-043 — Power-Grid Minimal Benchmark Result Freeze 0.1
Status: FROZEN. Rollback `RP-015`; exact mean/COI closure mandatory limitation.
...
Status: FROZEN / COMPLETE. PASS; `E_target_max=2.076727044536923e-15`, `E_no_min=0.06534774384334105`, `E_mismatch_min=0.1307357122731585`, max input `0.20881049376163438`, energy `0.04006381839386479`; `5 passed`.
...
Status: FROZEN. Rollback `RP-021`.

### DEC-061 — Manuscript Initial Draft 0.1 authorised
Status: SATISFIED / CLOSED.

### DEC-062 — Manuscript Initial Draft 0.1 returned
Status: FROZEN / COMPLETE. Canonical draft `research/manuscript/manuscript_initial_draft_0_1.md`; commit `143712a86258f55db3b1d2f58ec6e4a8b32e7579`.

### DEC-063 — Manuscript Initial Draft Freeze 0.1
Status: FROZEN. Rollback `RP-022`.
...
Status: FROZEN / COMPLETE. `GO — EDITORIAL COMPLETION ONLY / NO NOVELTY PROMOTION`.

### DEC-066 — Manuscript Initial Draft Compliance Freeze 0.1
Status: FROZEN. Rollback `RP-023`.

### DEC-067 — Manuscript Editorial Completion 0.1 authorised
Status: SATISFIED / CLOSED.

### DEC-068 — Manuscript Editorial Completion 0.1 returned
Status: FROZEN / COMPLETE. Canonical `research/manuscript/manuscript_editorial_completion_0_1.md`; commit `f1531222ceab86151d244ce31a2e921d980a1fa8`; no scientific change.

### DEC-069 — Manuscript Editorial Completion Freeze 0.1
Status: FROZEN. Rollback `RP-024`.
...
Status: FROZEN / COMPLETE. `GO — VENUE-NEUTRAL ARTIFACT COMPLETION ONLY / NO NOVELTY PROMOTION`; Figure 3 schematic/non-trajectory only.

### DEC-072 — Manuscript Submission Readiness & Artifact Packaging Freeze 0.1
Status: FROZEN. Rollback `RP-025`.

### DEC-073 — Manuscript Venue-Neutral Artifact Completion 0.1 authorised
Status: SATISFIED / CLOSED. Four frozen-role SVG schematics, complete Appendices A–F, reproducibility manifest and package/index only.

### DEC-074 — Manuscript Venue-Neutral Artifact Completion 0.1 returned
Status: FROZEN / COMPLETE. Canonical package `research/manuscript/venue_neutral_0_1/`; content completion commit `593dd2192eca8e378bffde09a6208420d8bbe9a4`; editorial manuscript blob `5116cb99a011416943bef908079ba7489eb597a3`; no scientific execution.

### DEC-075 — Manuscript Venue-Neutral Artifact Completion Freeze 0.1
Status: FROZEN. Rollback `RP-026`; original package immutable; CORE manifest pointer-role discrepancy flagged.
...
Status: FROZEN / COMPLETE. `REVISE — ARTIFACT COMPLIANCE FIXES REQUIRED / NO NOVELTY PROMOTION`; all science/claims/figures/supplement pass; sole defect CORE commit-role labeling.

### DEC-078 — Manuscript Venue-Neutral Artifact Integration & Compliance Freeze 0.1
Status: FROZEN. Rollback `RP-027`; freezes full compliance finding and exact metadata-only correction scope; `RP-026` remains immutable.

### DEC-079 — Manuscript Venue-Neutral Artifact Metadata Correction 0.1 authorised
Status: SATISFIED / CLOSED. Assigned MANUSCRIPT; must create `venue_neutral_0_2`, preserve figures/supplement byte-identically, correct CORE commit roles only.

### DEC-080 — Manuscript Venue-Neutral Artifact Metadata Correction 0.1 returned
Status: FROZEN / COMPLETE. Corrected package `research/manuscript/venue_neutral_0_2/`; artifact-copy commit `d9f65a0c27d8ba9a7be22058fe737038e89e122c`; corrected manifest `cad1efe7d5791e0c01d3c05410fe61fa04b26cb3`; README `0d15aa3656d1fadf6e582a6cc3beb8e4f830dc7b`; CHANGELOG/content completion `936187e4d31a2c81ed8e0c77902ba6f8e70a9f21`. Correctly distinguishes CORE result commit `0ebd50e5c8c072cf59ae86502a25b97e78c4722f` from later STATUS bookkeeping commit `1cad9c78c4f76484cb5e2197ce9c128c5f94f4ff`; figures/supplement carried forward byte-identically; no science/venue/submission action.

### DEC-081 — Manuscript Venue-Neutral Artifact Metadata Correction Freeze 0.1
