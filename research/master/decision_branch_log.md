...
Status: FROZEN
`research/master/PROJECT_GOVERNANCE_0_1.md` is canonical.

### DEC-002 — Git as single source of truth
Status: STABLE
Repository `twkroll/causal_synergetics` is canonical persistent state.

### DEC-003 — Lazy chat creation
Status: STABLE
Specialist chats open only by MASTER authorisation; absent chats are `UNOPENED`.
...
Prior-Art & Definitions Audit returned `PASS — CLAIM-RESTRICTED`; action `RESTRICT / REINTERPRET`.

### DEC-006 — CORE dependency on first literature audit
Status: SATISFIED / CLOSED
CORE stayed unopened until LIT freeze.
...
Status: FROZEN
Generic intervention-conditioned state, controlled-equivalence, low-dimensional sufficiency and controlled-closure novelty claims prohibited; controlled state preparation prior-art-restricted.

### DEC-009 — Surviving CORE boundary
Status: SATISFIED / CLOSED
CORE tested classical slaving/order-parameter structure against intervention-relative sufficiency/closure.

### DEC-010 — Applications blocked pending CORE
Status: SATISFIED / CLOSED
No application opened before CORE return.
...
Status: SATISFIED / CLOSED
Extensions waited for minimal benchmark.
...
Status: SATISFIED / CLOSED
Historical reachability returned first.
...
Canonical `research/master/neural_vertical_slice_go_revise_stop_0_1.md`; GO — CLAIM-RESTRICTED; rollback `RP-007`.

### DEC-022 — Neural Response Coordinate Specification Gate 0.1 authorised
Status: SATISFIED / CLOSED
Specification preceded held-out inspection.
...
Status: FROZEN
Rollback `RP-009`; no repair by family/coordinate/baseline/split/metric/threshold/horizon changes.

### DEC-027 — Neural Response Coordinate WEAK Integration Gate 0.1
Status: SATISFIED / CLOSED
Canonical `research/master/neural_response_coordinate_weak_integration_0_1.md`; REVISE; rollback `RP-010`.
...
Status: FROZEN
`(U,v)->(QU,Qv)` with subgroup `Q(phi)=R(phi)⊕I3`.
...
Status: SATISFIED / CLOSED
APP-A executed frozen specification.
...
Status: FROZEN
Rollback `RP-012`; no repair/relabel.
...
Status: FROZEN
Further repair parked because symmetry-aware Gram-PCA matches candidate and incremental value is low.

### DEC-037 — Nuisance FAIL Integration Freeze 0.1
Status: FROZEN
Rollback `RP-013`; APP-A PARKED / FROZEN / WAIT.

### DEC-038 — Post-coordinate programme reselection
Status: STABLE / SELECTED
Cross-domain transfer selected before further neural depth.

### DEC-039 — Power-Grid Minimal Benchmark Feasibility & Specification Gate 0.1 authorised
Status: SATISFIED / CLOSED
Specification preceded effect inspection.
...
Status: SATISFIED / CLOSED
APP-B executed frozen benchmark.
...
Status: FROZEN
Rollback `RP-015`; exact mean/COI closure mandatory claim limitation.

### DEC-044 — Cross-Domain Intervention-Sufficiency Integration Gate 0.1 authorised
Status: SATISFIED / CLOSED
Integrated through `RP-015`.
...
Status: FROZEN
Rollback `RP-016`; no result promoted/repaired/weakened.

### DEC-047 — Controlled State Preparation Feasibility & Specification Gate 0.1 authorised
Status: SATISFIED / CLOSED
Specification only, before outcome inspection.
...
Status: SATISFIED / CLOSED
APP-C executed frozen P0/PT/PM benchmark only.
...
Status: SATISFIED / CLOSED
Integrated through `RP-018` without new science.
...
Status: SATISFIED / CLOSED
LIT audit restricted to C1–C5 and package.
